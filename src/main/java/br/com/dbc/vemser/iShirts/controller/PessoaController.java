...
public class PessoaController {
    ...
    @GetMapping
    public ResponseEntity<Page<Pessoa>> buscarTodasPessoas(Pageable pageable) {
        Page<Pessoa> pessoas = pessoaService.buscarTodasPessoas(pageable);
        return new ResponseEntity<>(pessoas, HttpStatus.OK);
    }

    @GetMapping("/{idPessoa}")
    public ResponseEntity<Pessoa> buscarPorId(Integer idPessoa) {
    ...
    public ResponseEntity<Pessoa> cadastrarPessoa(PessoaCreateDTO pessoaDTO) {
    ...
    public ResponseEntity<Pessoa> atualizarPessoa(@PathVariable Integer idPessoa, @RequestBody PessoaCreateDTO pessoaDTO) {
